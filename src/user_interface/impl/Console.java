...
public class Console implements UserInterface {
    ...
    public Integer requestModeSelection() {
        ...
        System.out.printf("========================================|\n");
        System.out.printf("                                        |\n");
        System.out.printf("                Predict (default) = '0' |\n");
        System.out.printf("                   Create network = '1' |\n");
        System.out.printf("                   Import network = '2' |\n");
    ...
    @Override
    public void showFileError(double totalAbsoluteError, double meanAbsoluteError, int sampleCount) {
        clearConsole();
        System.out.printf("========================================|\n");
        System.out.printf(" ERROR FROM TRAINING DATA FILE          |\n");
        System.out.printf("========================================|\n");
        System.out.printf(" Samples ------------------------------ | %d\n", sampleCount);
        System.out.printf(" Total absolute error ----------------- | %.8f\n", totalAbsoluteError);
        System.out.printf(" Mean absolute error (MAE) ------------ | %.8f\n", meanAbsoluteError);
        System.out.printf("                                        |\n");
    }
